...
public class AdminLogin extends HttpServlet
{
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
   {
		...
		out.println("<html><head><title>Admin Login</title></head>");
		int flag=0;
		Statement stmt= null;
		String sql=null;
		...
		try
		{
			...
			while(rs.next())
			{
				String uname = rs.getString("Adminname");
			...
			if(flag==0)
			{
				out.println("<br><center><h2 style=\"top: 20vh; width: 100%; text-align: center;font-size:4vh;height:2vh;\">Invalid Admin Credentials! Try Again.<h2></center><br><br>");
				RequestDispatcher rd2 = request.getRequestDispatcher("admin.html");
