...
public class UserLogin extends HttpServlet
{
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
   {
		...
		out.println("<html><head><title>User Login</title></head>");
		int flag=0;
		Statement stmt= null;
		String sql=null;
		...
		try
		{
			...
			if(flag==0)
			{
				out.println("<br><center><h2 style=\"top: 20vh; width: 100%; text-align: center;font-size:4vh;height:2vh;\">Invalid User Credentials! Try Again.<h2></center><br><br>");
